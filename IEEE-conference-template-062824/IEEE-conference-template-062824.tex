...
\title{Adaptive Multi-Agent Real Estate Trading Systems: A Framework for Cross-Jurisdictional Profit Maximization\\
%{\footnotesize \textsuperscript{*}Note: Sub-titles are not captured for https://ieeexplore.ieee.org  and
%should not be used}
%\thanks{Identify applicable funding agency here. If none, delete this.}
}

\author{\IEEEauthorblockN{Chharesh Sehgal}
\IEEEauthorblockA{\textit{University of Nottingham} \\
\textit{20401887}\\
Bangkok, Thailand \\
hfycs2@nottingham.edu.my}
\and
\IEEEauthorblockN{Youssef Mohamed Abdelhamid Mohamed}
\IEEEauthorblockA{\textit{University of Nottingham} \\
\textit{20398219}\\
Abu Dhabi, UAE \\
hcyym1@nottingham.edu.my}
}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.49\textwidth]{Diagrams/Real Estate Trading Agent System Diagram}
    \label{fig:figure}
\end{figure}
