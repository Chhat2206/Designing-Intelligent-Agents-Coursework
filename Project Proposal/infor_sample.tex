...
\author[a]{\inits{F.}\fnms{Chhatresh} \snm{Sehgal}\thanksref{c1}\ead[label=e1]{hfycs2@nottingham.edu.my}\bio{bio1}}
\author[b]{\inits{S.}\fnms{Youssef} \snm{Mohamed}\thanksref{f1}\ead[label=e2]{????@nottingham.edu.my}\bio{bio2}}
...
f(S)-f(T) = {} & D_k^T\bigl(1+C_{\geq k+1}^T\bigr)(1 + C) + C_k^T\bigl(1+D_{\geq k+1}^T\bigr)(1 + D) \nonumber    \\
          ...
          = {} & \bigl[(1+C_{\geq k+1})(1+C)-\bigl (1+D_{\geq k+1}^T\bigr)(1+D)\bigr]>0.
\end{align}
